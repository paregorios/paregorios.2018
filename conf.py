...
BLOG_AUTHOR = "Tom Elliott"  # (translatable)
BLOG_TITLE = "paregorios.org"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://paregorios.org/"
...
DEPLOY_COMMANDS = {
    'default': [
        'rsync -rav --exclude=resources/roman-emperors '
        '--exclude=ahawk00 --delete output/ '
        'paregorios.org:/var/www/html/pa/paregorios.org'
    ]
}
